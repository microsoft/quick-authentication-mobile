...
public class AcquireCurrentTokenTask implements Convert<IClientApplication, Task<MSQAAccountInfo>> {
  ...
  @Override
  public Task<MSQAAccountInfo> convert(@NonNull final IClientApplication clientApplication)
      throws Exception {
    return Task.create(
