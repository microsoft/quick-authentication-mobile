...
public class AcquireTokenTask implements Convert<IClientApplication, Task<TokenResult>> {
  ...
  @Override
  public Task<TokenResult> convert(@NonNull final IClientApplication iClientApplication)
      throws Exception {
    return Task.create(
