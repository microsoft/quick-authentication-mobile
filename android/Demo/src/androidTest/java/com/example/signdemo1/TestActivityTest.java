...
public class TestActivityTest {
    @Rule
    public ActivityTestRule activityTestRule = new ActivityTestRule(TestActivity.class);

    @Test
    public void test() {
//        Espresso.onView(withId(R.id.text_click_button)).perform(typeText("2"), closeSoftKeyboard());
